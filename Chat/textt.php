...
$result = mysql_query("SELECT * FROM `chats` WHERE `chatname`='".$_GET['chatname']."'") or die(mysql_error());
...
if (isset($_GET['chatnameno'])){
$_SESSION['dn']=$_GET['chatnameno'];
header('Location: delete.php');}
?>
<html>
<head>
<title>
<?php  echo $_GET["chatname"]; ?>
</title>
